...
export default function AdminJobs() {
  ...
  useEffect(() => {
    const fetchJobs = async () => {
      try {
        ...
        toast({ description: "Failed to load jobs" });
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({ description: "Failed to create job posting" });
    }
  };
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      ...
      toast({ description: "Job posting deleted successfully" });
    } catch {
      toast({ description: "Failed to delete job posting" });
    }
  };
